...
<!-- RadioCase.php เป็นส่วน Radio Input -->
<?php include('RadioCase.php'); ?>
<!-- YearCityDropDown เป็นส่วน แสดงเมืองตามปีที่เลือก -->
<?php include('YearCityDropdown.php'); ?>
<!-- lowIncomeCityLogic เป็นส่วน แสดงเมืองที่มี wbinc เป็น Low Income ตามปีที่เลือก -->
...
<body>
    ...
    <div class="embed-container"><iframe width="500" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="All City" src="//aisciqq41hcqqoka.maps.arcgis.com/apps/Embed/index.html?webmap=747a4f45af624028979cc6eff72d7d10&extent=7.5419,40.5144,33.4257,50.2898&home=true&zoom=true&previewImage=false&scale=true&search=true&searchextent=true&basemap_gallery=true&disable_scroll=false&theme=light"></iframe>
